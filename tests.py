...
from modules import SimpleConv, ReLU, SummationModule
import torch
...
mg.add_module(SummationModule("summation"))
...
mg.add_connection("relu2", "summation")
mg.add_connection("relu1", "summation")  # Adding a skip connection
mg.add_connection("summation", "OutputModule")
